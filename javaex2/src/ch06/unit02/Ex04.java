...
public class Ex04 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// System.out.println(t.b); // 컴파일 오류. private 이므로
		t.disp();
	}
...
class Test4 {
	...
	// 인스턴스변수는 new를 통해 객체를 생성할때 힙영역에 메모리를 할당 받음
	int a;
	private int b = 100;

	// 필드-클래스변수:객체생성과 상관없이 접근하여 사용가능
