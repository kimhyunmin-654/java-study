...
public class Ex02_Integer {
	...
	public static void main(String[] args) {
		...
		s1 = "123";
		s2 = "456";
		System.out.println(s1 + s2); // 123455 문자열 결합
		...
		a = Integer.parseInt("1011", 2); // 10진수 문자열을 정수로 변환
		...
		s1 = Integer.toBinaryString(a); // 10진수 정수를 2진수 형식으로
		System.out.println(s1); // "1111011"
		
		s1 = Integer.toHexString(a); // 10진수 정수를 16진수형식의 문자열로
