...
public class Ex07_Vector {
	...
	public static void main(String[] args) {
		...
		System.out.println("처음 : " + list.get(list.size() - 1));
		System.out.println("처음 : " + list.lastElement());
		System.out.println("처음 : " + list.getLast());
		...
		System.out.println("용량 : " + list.capacity()); // 13
